...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("676183310660-vmbfh9iu7mjmdr7pmpea0mcovn1k74du.apps.googleusercontent.com")
                .requestEmail()
                .build();
...
//                            updateUI(user);
                            ...
                            Toast.makeText(LoginActivity.this,"Gagal Authentifikasi",Toast.LENGTH_SHORT).show();
